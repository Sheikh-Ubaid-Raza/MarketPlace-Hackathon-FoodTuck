...
const TestimonialHome = () => {
  return (
    <div className='bg-black'>
            <div className="flex max-w-[1273px] px-10 mx-auto flex-col gap-2 py-6">
            <h1 className="md:text-[32px] text-[24px] font-normal text-[#FF9F0D] font-greatVibes">
             Testimonials
           </h1>
              <h1 className="text-[35px] md:text-5xl Headings text-white font-bold">
            ...
            <div className="flex items-center justify-center py-24 px-4">
              <div className="relative bg-white max-w-[600px] mx-auto shadow-md py-10 px-8 text-center">
                ...
                <div className="absolute top-[-50px] left-1/2 transform -translate-x-1/2">
                  <Image
                    src="/testimonial.png" // Replace with actual profile image
                    alt="Profile"
                    width={100}
                    height={100}
