...
import CartHero from "@/components/MainHero/CartHero";
                                ...
                                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mt-8">
                                    <div className="w-full lg:w-1/2 mb-6 lg:mb-0">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            />
                                            <button className="bg-[#ff9f0d] text-white px-6 py-2 rounded-r font-semibold">
                                                Apply
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full lg:w-1/3">
                                        <div className="bg-gray-100 p-4 md:p-6 rounded-lg">
                                            ...
                                            <Link href={"/checkout"}>
                                                <button className="w-full bg-[#ff9f0d] text-white mt-4 py-3 rounded font-semibold">
                                                    Proceed to Checkout
                                                </button>
                                            </Link>
                                        </div>
